...
#define L1_SIZE 32768  //TODO
#define L2_SIZE 262144 //TODO
#define L3_SIZE 6291456//TODO
...
int main (int ac, char **av) {
    ...
    for (int i=0; i<SAMPLES; i++){
	    //clflush((void *) target_buffer);
	    tmp = target_buffer[0]; // bring into L1

	    for (int j = 0; j<3000; j++) { // evict out of L1
    ...
    for (int i=0; i<SAMPLES; i++){
	    ...
	    for (int j = 0; j<18000; j++) { // evict out of L1 and L2.
	    	tmp = eviction_buffer[j*64];
	    }
